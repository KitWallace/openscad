...
B=150;    
scale=1.2;
colors = ["blue","pink","Burlywood","salmon","powderblue","teal","peru","Sienna"];
n=10;
m=10;
inset=0.5;
$fn=100;

tiles=R11_tiles(B,n,m);
light_circle(90,2)
...
function R11_partial(B,b,c)  =
   [[b,B],[c,360-2*B],[2+c,270-B],[2+c,2*B-180],[1,90]];
   
function f(x,V)=
    let (p= R11_partial(V[0],x[0],x[1]))
    let(t=peri_to_tile(p,true))
    path_error(t);

function R11_tiles(B,n,m) =
